...
class ArticleModel extends Model{
	 ...
	 */
	public function get_index($id,$limit=20){
		// where a.a_id='$id' and a_del='$del'
		$sql="select a.a_id,a.a_title,a.a_desc,a.a_create_time,a.a_hits,a.a_content,a.c_id,u.u_name,c.c_name from blog_article  a join blog_user u on a.u_owner = u.u_id join blog_category c on a.c_id = c.c_id where a.a_del = 1 and  a.a_top = 1 limit 0,$limit ";
		return $this-> dbh ->my_fetchAll($sql);
	}
	/**
	 * /获取article表一条数据
