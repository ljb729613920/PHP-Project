<?php /* Smarty version Smarty-3.1.16, created on 2018-01-06 23:11:20
         compiled from ".\App\admin\views\Category\modify.html" */ ?>
<?php /*%%SmartyHeaderCode:158135a50d5e3af1785-23282581%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '158135a50d5e3af1785-23282581',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5a50d5e3b42d12_70276092',
  'variables' => 
  array (
    'one' => 0,
    'data' => 0,
...
<?php if ($_valid && !is_callable('content_5a50d5e3b42d12_70276092')) {function content_5a50d5e3b42d12_70276092($_smarty_tpl) {?><!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="tab-body"> <br />
      <div class="tab-panel active" id="tab-set">
        <form method="post" class="form-x" action="index.php?g=admin&c=category&a=update">
          <input type="hidden" name='c_id' value='<?php echo $_smarty_tpl->tpl_vars['one']->value['c_id'];?>
'>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="c_name" name="c_name" size="50" value="<?php echo $_smarty_tpl->tpl_vars['one']->value['c_name'];?>
...
?>
                <?php if ($_smarty_tpl->tpl_vars['one']->value['c_id']==$_smarty_tpl->tpl_vars['v']->value['c_pid']) {?><?php continue 1?><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['one']->value['c_id']==$_smarty_tpl->tpl_vars['v']->value['c_pid']) {?><?php continue 1?><?php }?>
                <option value="<?php echo $_smarty_tpl->tpl_vars['v']->value['c_id'];?>
" <?php if ($_smarty_tpl->tpl_vars['one']->value['c_pid']==$_smarty_tpl->tpl_vars['v']->value['c_id']) {?>selected<?php }?> ><?php echo str_repeat('--',$_smarty_tpl->tpl_vars['v']->value['lv']);?>
<?php echo $_smarty_tpl->tpl_vars['v']->value['c_name'];?>
          ...
          <div class="form-group">
            ...
            <div class="field">
              <textarea class="input" name="c_desc" id="c_desc" rows="5" cols="50" placeholder="描述" data-validate="required:请填写分类描述"><?php echo $_smarty_tpl->tpl_vars['one']->value['c_desc'];?>
</textarea>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="field">
              <input type="text" class="input" id="c_sort" name="c_sort" size="50" value="<?php echo $_smarty_tpl->tpl_vars['one']->value['c_sort'];?>
